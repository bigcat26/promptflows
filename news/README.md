...
pf connection create --file azure_openai.yaml --set api_key=sk-xxxxx --set api_base=https://api.lkeap.cloud.tencent.com/v1 --set api_type=openai --name tencent
